...
export function MiniContactForm({ locale, source = 'mini-form', attachment }: MiniContactFormProps) {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch('/api/lead', {
        ...
        body: JSON.stringify({ name, phone, website, source, locale, ...(attachment ? { attachment } : {}) }),
      })
